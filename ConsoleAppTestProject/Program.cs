    ...
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                BreezeConnect breeze = new BreezeConnect(API_KEY);
                breeze.generateSessionAsPerVersion(SECRET_KEY, SESSION_TOKEN);
                ////////////////////////WebSocket////////////////////////
                var responseobject = await breeze.wsConnectAsync();
                // Get Customer details by api-session value.
                Console.WriteLine(JsonSerializer.Serialize(breeze.getCustomerDetail(apiSession: SESSION_TOKEN)));
                ...
                Console.WriteLine(JsonSerializer.Serialize(breeze.getQuotes(stockCode: "RADMED", exchangeCode: "NSE",
                    expiryDate: "2022-08-25T06:00:00.000Z", productType: "cash", right: "others", strikePrice: "0")));
                ...
                Console.WriteLine(JsonSerializer.Serialize(breeze.placeOrder(stockCode: "5PACAP", exchangeCode: "NSE", productType: "cash", action: "buy", orderType: "limit", stoploss: "0", quantity: "1", price: "200", validity: "day", validityDate: "2022-08-22T06:00:00.000Z", disclosedQuantity: "0", expiryDate: "2022-08-25T06:00:00.000Z", right: "others", strikePrice: "0", userRemark: "Test", orderTypeFresh: "", orderRateFresh: "")));
